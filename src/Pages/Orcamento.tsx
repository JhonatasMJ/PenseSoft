    ...
    <>
      <>
        <section className="bg-ciano relative " id="orcamento">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-1 relative pb-48 items-baseline gap-4">
            <h2 className="text-1xl font-bold text-cinza mb-0 mt-2">Faça um</h2>
            <h1 className="text-4xl text-white font-bold">Orçamento</h1>
            <p className="text-black text-1xl mt-6 w-[52%]">
              Quer saber mais sobre nossas soluções ou discutir como podemos
              ajudar o seu negócio a crescer? Estamos aqui para responder às
              suas dúvidas e oferecer o suporte que você precisa.
            </p>
          </div>
        </section>
        ;
      ...
      <section className="max-w-7xl mx-auto pb-44 pt-20">
        <div className="bg-white max-w-7xl mx-auto grid grid-cols-[498px_770px] gap-0 relative items-center top-[-220px] h-auto w-full">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 w-full h-full">
            ...
            <Controller
              ...
              rules={{
                ...
                pattern: {
                  ...
                  message: "O e-mail deve ter a extensão .com ou .com.br",
                },
              }}
              render={({ field }) => (
                <TextField
            ...
            >
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select {...field} label="Faturamento anual estimado*">
                    <MenuItem value="Até R$ 1 milhão">Até R$ 1 milhão</MenuItem>
            ...
            >
              ...
              <Controller
                ...
                control={control}
                rules={{
                  required: "Selecione a quantidade de colaboradores",
                }}
                render={({ field }) => (
                  <Select
                    {...field}
                  ...
                  >
                    ...
                    <MenuItem value="Mais de 20">Mais de 20</MenuItem>
                  </Select>
                )}
              />
              {errors.colaboradores && (
                <FormHelperText>{errors.colaboradores.message}</FormHelperText>
              )}
            </FormControl>
            <FormControl fullWidth margin="normal" error={!!errors.modulosERP}>
              <FormLabel>
              ...
              <Controller
                ...
                rules={{
                  validate: {
                    atLeastOne: (value) =>
                      value.length > 0 || "Selecione pelo menos um item",
                  },
                }}
                render={({ field }) => (
                  <FormGroup>
            ...
            >
              <InputLabel>
                Quantos usuários irão utilizar o sistema inicialmente?*
              </InputLabel>
              <Controller
                name="colaboradores"
                control={control}
                rules={{
                  required: "Selecione a quantidade de usuários",
                }}
                render={({ field }) => (
                  <Select
                    {...field}
                  ...
                  >
                    ...
                    <MenuItem value="Mais de 20">Mais de 15</MenuItem>
                  </Select>
                )}
              />
              {errors.colaboradores && (
            ...
            >
              <InputLabel>Prazo estimado para implementação do ERP*</InputLabel>
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    ...
                    <MenuItem value="1 a 3 meses">1 a 3 meses</MenuItem>
                    <MenuItem value="3 a 6 meses">3 a 6 meses</MenuItem>
                    <MenuItem value="Mais de 6 meses">Mais de 6 meses</MenuItem>
                  </Select>
                )}
              />
            ...
            >
              <FormLabel>Já utilizou algum sistema ERP antes?*</FormLabel>
              <Controller
                name="usouERPAntes"
                control={control}
              ...
              />
              {errors.usouERPAntes && (
                <FormHelperText>{errors.usouERPAntes.message}</FormHelperText>
              )}
            </FormControl>
            ...
            >
              <InputLabel>
                Qual é o seu orçamento aproximado para um sistema ERP
                (mensalidade)?*
              </InputLabel>
              <Controller
                ...
                control={control}
                rules={{
                  required: "Selecione um orçamento aproximado",
                }}
                render={({ field }) => (
                  <Select
                    {...field}
                  ...
                  >
                    <MenuItem value="500">Até R$ 500,00</MenuItem>
