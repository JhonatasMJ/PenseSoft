...
const cardData = [
	{
		...
		description:
			'Nosso ERP é projetado para ser flexível e configurável, moldando-se às suas regras de negócio. Com isso, você obtém uma solução que realmente funciona para você, sem comprometer os processos que tornam sua empresa única.',
	},
	{
		icon: UserPen,
		title: 'Soluções personalizadas para seu sucesso',
		description:
			'Se o que você precisa ainda não foi desenvolvido, nossa equipe se encarrega de criar a solução sob medida para o seu negócio. Não vendemos apenas software; entregamos resultados concretos e adaptados às suas demandas.',
	},
	{
		icon: Handshake,
		title: 'Atendimento humanizado e eficiente',
		description:
			'Nosso compromisso vai além da tecnologia. Valorizamos o relacionamento com nossos clientes, oferecendo suporte contínuo e personalizado para garantir que suas necessidades sejam sempre atendidas com a atenção que merecem.',
	},
	{
		icon: Banknote,
		title: 'Custo-benefício inigualável para seu Investimento',
		description:
			'Tecnologia de ponta com preços acessíveis, garantindo que você maximize o retorno sobre o investimento. Proporcionamos valores reais ao seu negócio, sem custos ocultos, tornando nosso ERP uma escolha inteligente e financeiramente vantajosa.',
	},
];
			...
			<div className="max-w-7xl mx-auto p-4 grid grid-cols-1 md:grid-cols-2 relative py-24 items-baseline gap-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-ciano-claro p-6 rounded-md relative">
					<img
						src={logo}
						alt=""
						className="absolute left-48p bottom-49p w-7 h-7 hidden md:flex"
					/>
