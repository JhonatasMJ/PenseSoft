            ...
            {isHomePage ? (
              <>
                <li className='cursor-pointer'>
                  <ScrollLink to="inicio" smooth={true} duration={500}>Inicio</ScrollLink>
                </li>
                <li className='cursor-pointer'>
              ...
              <>
                <li><Link to="/" state={{ scrollTo: 'inicio' }}>Inicio</Link></li>
                <li><Link to="/" state={{ scrollTo: 'sobre' }}>Sobre</Link></li>
              </>
            )}
